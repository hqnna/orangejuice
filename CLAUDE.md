...
`OJ_JAI_DIR`, `OJ_LOG`, `OJ_THREADS`, `OJ_TIMING`, `OJ_CODEGEN_UNITS`,
...
`vendor/jai/modules/Default_Metaprogram.jai` — its `case "-…"` labels in pass 1
